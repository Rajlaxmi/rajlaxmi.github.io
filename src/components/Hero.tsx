    ...
    <div className="flex min-h-[88vh] flex-col justify-center pb-20 pt-32 sm:pt-40">
      <div className="grid gap-14 lg:grid-cols-[minmax(0,1fr)_18rem] lg:gap-20">
        <div>
          ...
          <p
            className="mt-6 max-w-measure text-[1.32825rem] italic text-muted sm:text-[1.518rem]"
            data-reveal
        ...
        >
          <blockquote className="text-[1.20175rem] leading-relaxed text-ink">
            “Once a computer achieves a human level, it will necessarily soar past it.”
          </blockquote>
          <figcaption className="mt-4 text-[1.012rem] italic text-muted">
