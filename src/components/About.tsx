...
const About: React.FC = () => (
  ...
  >
    <p className="mt-8 max-w-measure text-[0.917580rem] text-muted" data-reveal>
    ...
    <blockquote
      className="mt-12 max-w-measure border-l border-accent/50 pl-6 text-[0.922435rem] italic text-ink"
      data-reveal
    >
