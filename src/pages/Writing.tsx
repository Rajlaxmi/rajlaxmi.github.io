    ...
    <div className="min-h-screen bg-paper">
      ...
      <main>
        <div className="mx-auto max-w-page px-6 pb-16 pt-32 sm:px-10 sm:pt-40">
          ...
          <p className="mt-6 max-w-[38rem] text-[1.027497rem] leading-[1.55] text-muted">
              ...
              <li key={post.slug} data-reveal>
                <Link to={`/blog/${post.slug}`} className="group block border-b border-rule py-7">
                  <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1">
                    <h3 className="text-[1.078871rem] text-ink transition-colors duration-300 group-hover:text-accent">
                      {post.title}
                    </h3>
                  ...
                  <p className="mt-4 flex items-center gap-2 text-[0.770621rem] text-faint transition-colors duration-300 group-hover:text-accent">
