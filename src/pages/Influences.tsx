              ...
              <li key={org.name} className="border-b border-rule py-8" data-reveal>
                <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1">
                  ...
                  >
                    ...
                    <span className="text-[1rem] text-ink transition-colors duration-300 group-hover:text-accent">
                      {org.name}
                    </span>
                    <ArrowUpRight
                      size={13}
                ...
                <p className="mt-3 max-w-measure border-l border-rule pl-4 text-[0.8rem] italic text-faint">
                  {org.impact}
                </p>
              </li>
            ))}
