    ...
    <div className="min-h-screen bg-paper">
      ...
      <main>
        <div className="mx-auto max-w-page px-6 pb-16 pt-32 sm:px-10 sm:pt-40">
          ...
          <p className="mt-6 max-w-[38rem] text-[1.25rem] leading-[1.55] text-muted">
              ...
              <li key={org.name} className="border-b border-rule py-8" data-reveal>
                <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-1">
                  ...
                  >
                    ...
                    <span className="text-[1.25rem] text-ink transition-colors duration-300 group-hover:text-accent">
                      {org.name}
                    </span>
                    <ArrowUpRight
                      size={13}
                ...
                <p className="mt-3 max-w-measure border-l border-rule pl-4 text-[0.95rem] italic text-faint">
                  {org.impact}
                </p>
              </li>
            ))}
