...
Every act of reasoning contains these eight moving parts. Mapping them makes hidden weaknesses visible. Purpose, question, information, concepts, assumptions, inferences, point of view, implications.
...
Once the elements are on the table, you interrogate each with nine standards: Clarity, accuracy, precision, relevance, depth, breadth, logic, significance, fairness.
...
Repeated use of the standards etches habits of mind: Humility, courage, empathy, integrity, perseverance, confidence in reason, autonomy.
